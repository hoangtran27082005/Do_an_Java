...
public class DBNhanVien {
	...
	private final String DELETE_NHANVIEN_ACCOUNT = "DELETE FROM account WHERE maNhanVien=?";
	...
	public void xoaNhanVien(int maNhanVien) {
        try {
            ...
            PreparedStatement p2 = con.prepareStatement(DELETE_NHANVIEN_ACCOUNT);
            p2.setInt(1, maNhanVien);
